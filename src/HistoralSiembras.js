...
export default class HistoralSiembras extends Component {
  constructor(props) {
    super(props);
	        ...
	        <View>
	          <FlatList
	              ...
	              renderItem={(item,index) => (
	                <TouchableOpacity
	                onPress={ () =>{ Actions.HistOneSiembra() /*Actions.HistOneSiembra() ListFactorQuimico*/} }
                  ...
                  <View style={styles.item}>
                      ...
                      <View style={{flexDirection:'column',justifyContent:'center',flex:1}}>
                        <Text style={styles.text}>#</Text>
          							<Text style={styles.text}>Producto: Platano</Text>
                        <Text style={styles.text3}>Fecha inicio:Domingo 18 de febrero 2018</Text>
                        <Text style={styles.text3}>Fecha Fin:Domingo 18 de febrero 2018</Text>
                        <Text style={styles.text2}>Promedio esperado:</Text>
          							<Text style={styles.text2}>Promedio resultado:</Text>
                      </View>
